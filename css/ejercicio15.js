...
function agregarElemento() {
    ...
    if (texto !== '') {
        ...
        li.classList.add('list-group-item', 'd-flex', 'justify-content-between', 'align-items-center');// Añadimos una clase al li
        ...
        // ¡Aquí es donde se le da la orden de borrar al hacer clic!
        botonEliminar.addEventListener('click', function () {
            li.remove();  // Eliminar el li al hacer clic
        });// Eliminar el li al hacer clic en el botón de eliminar
